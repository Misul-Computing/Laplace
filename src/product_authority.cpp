...
ValidatedLoadResult load_carried_manifest(const ArtifactIndex& physical,
    ...
    // Validate the proof already attached to the immutable manifest. Product
    // authority is granted only by ProductPackage after the token program has
    // also closed over this manifest.
    ...
    diagnostics.importer_name = "carried-manifest-v1";
